...
public class SSHPublisherTransfer implements Buildable{
	...
	public void build(Builder builder) {
		...
		if (execCommand.trim().isEmpty() && sourceFiles.trim().isEmpty()){
			builder.createMethod("execCommand").withStringParameter("ls").endMethod();
		}
		else {
